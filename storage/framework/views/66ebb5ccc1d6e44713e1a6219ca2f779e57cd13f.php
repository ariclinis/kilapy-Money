...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title><?php echo $__env->yieldContent('titulo','kilapi Money'); ?></title>
  ...
  <body>
      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse" id="navbar-main">
          ...
          <ul class="nav navbar-nav navbar-right">
            <li><a href="<?php echo e(route('register')); ?>" target="_blank"><i class="fa fa-check-square-o"></i> Cadastre-se</a></li>
            <li><a href="<?php echo e(route('login')); ?>"><i class="fa fa-user"></i> Entrar</a></li>
          </ul>
    ...
    <footer class="navbar-default footer" style="margin: 0;width: 100%; padding: 0;" >
      <div class="container">
